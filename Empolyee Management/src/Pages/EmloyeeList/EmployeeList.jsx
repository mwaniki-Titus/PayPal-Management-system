...
// import React, { useState } from 'react';
// import './EmployeeList.scss';
// import { useGetEmployeesQuery, useDeleteEmployeeMutation, useAddEmployeeMutation, useGetEmployeebyIDQuery } from '../../Features/User/UserApi'; // Import the new query hook
// import ModalForm from './EmployeeForm';
...
//     const [deleteEmployee] = useDeleteEmployeeMutation();
//     const [addEmployee] = useAddEmployeeMutation();
//     const { data: employeeDetails, error: employeeError, isLoading: employeeLoading, refetch: refetchEmployeeDetails } = useGetEmployeebyIDQuery(); // Use the new query hook
//     // const [isModalOpen, setIsModalOpen] = useState(false); 
...
//             setSelectedEmployee(employee);
//             setIsDetailViewOpen(true);
//             // No need to refetch employee details here, as you already have the employee data
//         } catch (error) {
//             console.error('Error fetching employee details:', error);
//         }
//     };
...
//                 </tbody>
//             </table>
//             {isDetailViewOpen && selectedEmployee && (
//                 <EmployeeDetails 
